...
public class RecetasModelServ {
	...
	public RecetasModelServ() {
		// TODO Auto-generated constructor stub
	}

	public RecetasModelServ(int idReceta, String nombre, String detalle, boolean activa, LocalDate creado, LocalDate actualizado,
			LocalDate eliminado) {
